...
<p>Tenzi is a dice game used to demonstrate the use of React Hooks (useState, useEffect).
...
Best scores are saved to local storage.</p>
...
Copyright (c) 2022 Georgia Kolesidou<br>
